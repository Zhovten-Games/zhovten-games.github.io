---
lang: "en"
title: "Language as Infection: Media Communication as a Mechanism of Harm"
shortertitle: "Language as Infection"
abstract: |
  A working paper on how language, speech, hearing, vision, and technical signals become channels of contagion and mechanisms of harm in media horror.
keywords: Canon Horror, horror, media horror, language, medium, contagion, perception, communication, signal, biopolitics, Metal Gear Solid V
link-bibliography: true
link-citations: true
bibliography:
  - "Bibliography/Theoretical Foundations.json"
  - "Bibliography/Case Studies.json"
  - "Bibliography/Primary Case Corpus.json"
  - "Bibliography/Infection Mechanics and Legal Framework.json"
zg_bibliography_sections:
  - title: "A. Theoretical Foundations"
    bibliography: "Bibliography/Theoretical Foundations.json"
    level: 3
  - title: "B. Case Studies"
    bibliography: "Bibliography/Case Studies.json"
    level: 3
  - title: "C. Primary Case Corpus"
    bibliography: "Bibliography/Primary Case Corpus.json"
    level: 3
...
![Cover of the article “Language as Infection: Media Communication as a Mechanism of Harm”](img/cover.png){#fig:MapClassicOfSongsYong width="100%"}
